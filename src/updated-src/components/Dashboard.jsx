...
function Dashboard({ files, walletAddress }) {
  ...
  const accentColors = {
    purple: { bar: 'bg-purple-500', dot: 'bg-purple-400', bg: 'from-purple-500/5' },
    blue: { bar: 'bg-blue-500', dot: 'bg-blue-400', bg: 'from-blue-500/5' },
    amber: { bar: 'bg-amber-500', dot: 'bg-amber-400', bg: 'from-amber-500/5' },
    emerald: { bar: 'bg-emerald-500', dot: 'bg-emerald-400', bg: 'from-emerald-500/5' },
  };
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1 text-sm">
          Overview of your decentralized media on Shelby
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
        {stats.map((stat) => {
          ...
          return (
            <div
              key={stat.label}
              className={`bg-gradient-to-br ${colors.bg} to-transparent border border-gray-800/40 rounded-xl p-4`}
            >
